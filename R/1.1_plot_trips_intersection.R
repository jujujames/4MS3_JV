...
## read tile -----
#register_stadiamaps(key = "21b4a662-e893-409f-ad6c-54a19a30e3fd", write = TRUE)
...
rayshader::render_label(heightmap = elev_matrix
                        , lat = tmp_stops1[shape_id == "1049212" & id == 1,]$Y-0.015
                        , long = tmp_stops1[shape_id == "1049212" & id == 1,]$X+0.02
                        , altitude = tmp_stops1[shape_id == "1049212"& id == 1,]$new_scale_altitude + 0
                        , zscale = 100
                        , textsize = 3
                        , adjustvec = c(0,-0.5)
                        , alpha = 0
...
rayshader::render_label(heightmap = elev_matrix
                        , lat = tmp_gps[shape_id == "1048833" & id == 1,]$shape_pt_lat-0.0055
                        , long = tmp_gps[shape_id == "1048833" & id == 1,]$shape_pt_lon+0.015
                        , altitude =   tmp_gps[shape_id == "1048833"& id == 1,]$new_scale_altitude -3000
                        , zscale = 100
                        , textsize = 3
                        , linewidth = 0
                        , alpha = 0
                        ...
                        , fonttype = "standard"
                        , text = tmp_stops1[shape_id == "1048833"& id == 1,]$text_plot
                        , clear_previous = F)
...
rayshader::render_label(heightmap = elev_matrix
                        ...
                        , altitude =   tmp_gps[shape_id == "1049212",.SD[.N]]$new_scale_altitude -3500
                        , zscale = 100
                        , textsize = 3
                        , linewidth = 0
                        , alpha = 0
...
rayshader::render_label(heightmap = elev_matrix
                        , lat = tmp_gps[shape_id == "1048833",.SD[.N]]$shape_pt_lat-0
                        , long = tmp_gps[shape_id == "1048833",.SD[.N]]$shape_pt_lon-0
                        , altitude =   tmp_gps[shape_id == "1048833",.SD[.N]]$new_scale_altitude -2750
                        , zscale = 100
                        , textsize = 3
                        , linewidth = 0
                        , alpha = 0
...
# save ----
dir.create("figures")
rayshader::render_snapshot(filename = "figures/intersection_ttc.png"
                           ,width = 500
                           ,height = 500)